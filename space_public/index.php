...
<div class="main">
    ...
    <div class="main-col-center text-center">
        ...
        if ($config->get('GEO_MODE_PUBLIC') >= 3 && $config->get('GEO_MODE_PUBLIC') < 5) {
            echo " : ";
            if ($vue == 'C') {
                echo 'Carte | <a href="' . $root . '/accueil?vue=T&xtyp=' . $xtyp . '"' . ($vue == 'T' ? ' class="bolder"' : '') . '>Tableau</a>';
            }

            if ($vue == 'T') {
                echo '<a href="' . $root . '/accueil?vue=C&xtyp=' . $xtyp . '"' . ($vue == 'C' ? ' class="bolder"' : '') . '>Carte</a> | Tableau';
            }
        }
        echo '</h2>';
