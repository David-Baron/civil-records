...
if ($request->getMethod() === 'POST') {
    ...
    if (empty($form_errors)) {
        ...
        if ($nb == 1) {
            ...
            $form_errors['email'] = 'Cette adresse email est référencée pour plusieurs comptes. Contactez nous directement <a href="' .$root .'/contact">ici.</a>';
        }
    }
}
...
<div class="main">
    ...
    <div class="main-col-center text-center">
        ...
        <p>
            <a href="<?= $root; ?>/acces">Voir les conditions d'accès à la partie privée du site</a>
        </p>
    </div>
</div>
