...
<div class="main">
    ...
    <div class="main-col-center text-center">
        ...
        <p><a href="<?= $root; ?>/acces">Voir les conditions d'accès à la partie privée du site</a></p>
        <p><a href="<?= $root; ?>/mon_compte/recuperation">Login ou mot de passe perdu ?</a></p>
        <?php if ($config->get('USER_AUTO_DEF') > 0) {
            ...
            <p>
                <a href="<?= $root; ?>/mon_compte/creation_compte"><b>Pas encore inscrit ? <?= $mescpte; ?></b></a>
            </p>
        <?php } ?>
    </div>
</div>
