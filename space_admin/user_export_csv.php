        ...
        if (! $missingargs) {
            ...
            if ($xaction == 'submitted' && $suppr <> "Y") {
                ...
                if ($nbdocs == 0) {
                    ...
                    echo '<p><a href="' . $root . '/admin/utilisateurs/export_csv">Retour</a></p>';
                } else {
                    if ($lelevel < 10) {
                        $texlevel = $lelevel;
                    } else {
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="lelevel" size="1">
                                <option <?= (0 == $lelevel ? 'selected' : ''); ?>>Public</option>
                                <option <?= (1 == $lelevel ? 'selected' : ''); ?>>1 : Liste des communes</option>
                                <option <?= (2 == $lelevel ? 'selected' : ''); ?>>2 : Liste des patronymes</option>
                                <option <?= (3 == $lelevel ? 'selected' : ''); ?>>3 : Table des actes</option>
                                <option <?= (4 == $lelevel ? 'selected' : ''); ?>>4 : Détails des actes (avec limites)</option>
                                <option <?= (5 == $lelevel ? 'selected' : ''); ?>>5 : Détails sans limitation</option>
                                <option <?= (6 == $lelevel ? 'selected' : ''); ?>>6 : Chargement NIMEGUE et CSV</option>
                                <option <?= (7 == $lelevel ? 'selected' : ''); ?>>7 : Ajout d' actes</option>
                                <option <?= (8 == $lelevel ? ' selected' : ''); ?>>8 : Administration tous actes</option>
                                <option <?= (9 == $lelevel ? 'selected' : ''); ?>>9 : Gestion des utilisateurs</option>
                                <option <?= (10 == $lelevel ? 'selected' : ''); ?>>Super administrateur</option>
                            </select>
                        </td>
                    </tr>
