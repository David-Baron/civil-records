...
<div class="main">
    ...
    <div class="main-col-center text-center">
        ...
        <?php if ($id > 0 && $act == "del") {
            ...
            header("Location: $root/admin/geolocalizations");
            exit();
        }
                ...
                <table class="m-auto" summary="Formulaire">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <?php if ($id > 0) { ?>
                                <a href="<?= $root; ?>/admin/geolocalizations/detail?id=<?= $id; ?>&amp;act=del">Supprimer cette localité</a>
                            <?php } ?>
                        </td>
                    </tr>
                </table>
        ...
        <?php } else { ?>
            <p>
                <a href="<?= $root; ?>/admin/geolocalizations">Retour à la liste des localités</a>
                <?php if ($id > 0 && $act != "del") { ?>
                    <a href="<?= $root; ?>/admin/geolocalizations/detail?id=<?= $id; ?>">Retour à la fiche de <?= getparam('commune'); ?></a>
                <?php } ?>
            </p>
        <?php } ?>
    </div>
