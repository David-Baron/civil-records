...
if (! $missingargs) {
    ...
    echo " </tr>\n";
    echo " <tr>\n";
    echo '<td align="right">Maximum d\'actes sélectionnés par requête&nbsp; &nbsp;<br />(voir <a target="_blank" href="' . 'gest_params.php?grp=Système">MAX_SELECT_REC</a>) 0 = pas de limite : &nbsp;</td>' . "\n";
