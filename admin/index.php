...
if (! defined('EA_TYPE_SITE')) {
    define('EA_TYPE_SITE', 'ACTES');
}
...
if ($xtyp == "N") {
    ...
    $menu_actes .= '<a href="' . mkurl($root . $chemin . "index.php", "N") . '">' . "Naissances" . "</a> | ";
}
if ($xtyp == "M") {
    $menu_actes .= "Mariages" . " | ";
} else {
    $menu_actes .= '<a href="' . mkurl($root . $chemin . "index.php", "M") . '">' . "Mariages" . "</a> | ";
}
if ($xtyp == "D") {
    $menu_actes .= "Décès" . " | ";
} else {
    $menu_actes .= '<a href="' . mkurl($root . $chemin . "index.php", "D") . '">' . "Décès" . "</a> | ";
}
if ($xtyp == "V") {
    $menu_actes .= "Divers";
} else {
    $menu_actes .= '<a href="' . mkurl($root . $chemin . "index.php", "V") . '">' . "Divers" . "</a>";
}
if ($xtyp == "A") {
    $menu_actes .= " | Tous";
} else {
    $menu_actes .= ' | <a href="' . mkurl($root . $chemin . "index.php", "A") . '">' . "Tous" . '</a>';
}
