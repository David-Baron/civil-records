...
class GenBtn
{
    ...
    function Show($value, $url)
    {
        ...
        echo '<a href="' . $url . '?show=flux" title="Un fil RSS est disponible pour cette rubrique (' . $this->titre . ')"><img src="' . $value . '"></a>';
    }
}
...
class GenRss
{
    ...
    function Load()
    {
        ...
        $this->entete .= '<channel>' . "\n\n";
        $this->generator = '<generator>Civil-Records ' . $config->get('EA_VERSION') . ' + ILIX MakeRss 0.2</generator>' . "\n";   // MERCI DE NE PAS ENLEVER CETTE LIGNE
    }
